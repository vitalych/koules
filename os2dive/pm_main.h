...
#define GetSnapHeight(x)                                                                                           \
    ((x) + 2 * WinQuerySysValue(HWND_DESKTOP, SV_CYSIZEBORDER) + 2 * WinQuerySysValue(HWND_DESKTOP, SV_CYBORDER) + \
     WinQuerySysValue(HWND_DESKTOP, SV_CYMENU) + WinQuerySysValue(HWND_DESKTOP, SV_CYTITLEBAR))
