...
#define CALTUP \
    11 // added another set of up/down/left/right controls for controlling
...
extern inline int Pressed() {
    return (SDL_JoystickGetButton(joy, GP2X_BUTTON_A) || SDL_JoystickGetButton(joy, GP2X_BUTTON_B) ||
            SDL_JoystickGetButton(joy, GP2X_BUTTON_X) || SDL_JoystickGetButton(joy, GP2X_BUTTON_Y) ||
            SDL_JoystickGetButton(joy, GP2X_BUTTON_CLICK) || SDL_JoystickGetButton(joy, GP2X_BUTTON_SELECT) ||
            SDL_JoystickGetButton(joy, GP2X_BUTTON_START) || SDL_JoystickGetButton(joy, GP2X_BUTTON_L) ||
