...
char *FILENAME[] = {
    "/start.raw", "/end.raw", "/colize.raw", "/destroy1.raw", "/destroy2.raw", "/creator1.raw", "/creator2.raw",
};
...
static ALport setup_dsp(char *dspdev) {
    ALport writePort;
    ALconfig writeConfig;

    static long audioParams[2] = {AL_OUTPUT_RATE, FREQUENCY};
...
static void do_everything(ALport writePort) {
    signed char k;
    int i, j;
