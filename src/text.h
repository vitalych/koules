...
#define CONTLINE 16
#define UDIVLINE 10
static char *bballtext[] = {"The DARK APPLEPOLISHER",
                            "has heard about you",
                            "You are famous",
...
static char *bbballtext[] = {"You entered the",
                             "PRIMARY ALARM ZONE",
...
static char *introtext[] = {
    "The best way", "to play KOULES",     "is to let you play", "without instructions", "...", "We can only advise you",
    "...",          "(connection failed)"};
static int INTROSIZE = (sizeof(introtext) / sizeof(char *));
static char *holetext[] = {"Our scientists have",
                           "developed a great",
                           "weapon",
                           "so powerful",
                           "that even you can",
...
static char *inspectortext[] = {"Standard KOULES", "inspectors were sent", "to monitor your actions",
                                //  "They can not be destroyed",
                                "They cannot be destroyed", "directly", "...", "Good luck", "..."};
static int INSPECTORSIZE = (sizeof(inspectortext) / sizeof(char *));
static char *magholetext[] = {"KOULES are not stupid", "They have developed a new", "funny weapon",
                              "which can be called",   "the MAGNETIC HOLE",         "..."};
static int MAGSIZE = (sizeof(magholetext) / sizeof(char *));
static char *springtext[] = {"Koules have", "more hidden qualities", "...",
                             //  "When they're in a danger",
                             "When they're in danger", "they spit on you", "...", "their spits sticks to you", "...",
#ifdef GCW
...
static char *thieftext[] = {"During the war",
                            "the Earth's power",
                            "resources have been",
                            "almost exhausted",
                            "...",
...
static char *findertext[] = {"Their competitors,", "the on-the-ground",
                             //  "organisation SURFACE",
                             "organization SURFACE", "developed a special", "persuaduing method", "which makes",
                             "a Thief become", "a complete boob", "which returns to you", "everything he has stolen",
                             "...", "Technical note", "This technology", "is based on UNIX",
...
static char *ttooltext[] = {
    "After intensive",      "research our scientists", "have finally stolen", "SUBWAY's technologies",       "...",
    "If you get a special", "chip you will be able",   "to steal energy",     "from other ships or B_BALLS",
};
static int TTOOLSIZE = (sizeof(ttooltext) / sizeof(char *));
static char *lunatictext[] = {" DANGER ",
                              "Our scientists",
                              "have been working",
                              "on very dangerous",
                              "virus",
