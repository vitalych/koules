...
extern int a_bballs, a_rockets, a_balls, a_holes, a_apples, a_inspectors, a_lunatics, a_eholes;
...
extern SDL_Surface *bball_bitmap, *apple_bitmap, *inspector_bitmap, *mouse_bitmap, *lunatic_bitmap,
    *lball_bitmap[NLETTERS], *circle_bitmap, *hole_bitmap, *ehole_bitmap, *ball_bitmap, *eye_bitmap[MAXROCKETS],
    *rocket_bitmap[MAXROCKETS];
...
#if defined(__GNUC__) && !defined(ONLYANSI)
extern int find_possition(float *, float *, CONST float) __attribute((const));
